...
import com.microservices.JipsterApp;
import com.microservices.config.AsyncSyncConfiguration;
import com.microservices.config.EmbeddedSQL;
...
@SpringBootTest(classes = { JipsterApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL
